...
if [ -z $user ]; then
echo -e "$COLOR1
${NC} [Error] Username cannot be empty "
echo -e "$COLOR1
${NC}" 
echo -e "$COLOR1
 BY 
...
${NC} Password    : ${uuid}"  
echo -e "$COLOR1
${NC} Cipers      : aes-128-gcm"  
echo -e "$COLOR1
${NC} Network     : ws/grpc"  
echo -e "$COLOR1
${NC} Path        : /ss-ws"  
echo -e "$COLOR1
${NC} ServiceName : ss-grpc"  
echo -e "$COLOR1
${NC}" 
echo -e "$COLOR1
${NC}"
...
${NC} "
echo -e "$COLOR1
${NC} Link JSON : http://${domain}/ss-$user.txt"  
echo -e "$COLOR1
${NC}" 
echo -e "$COLOR1
 BY 
...
echo -e "$COLOR1
${NC}  
 [NOTE] Press any key to back on menu"
echo -e "$COLOR1
${NC}" 
echo -e "$COLOR1
 BY 
...
${NC}"
echo -e "$COLOR1
${NC}   [INFO]  $user Account Renewed Successfully"
echo -e "$COLOR1
${NC}   "
echo -e "$COLOR1
${NC}   Client Name : $user"
echo -e "$COLOR1
${NC}   Days Added  : $masaaktif Days"
echo -e "$COLOR1
${NC}   Expired On  : $exp4"
echo -e "$COLOR1
${NC}" 
...
echo -e "$COLOR1
${NC}  
 You Dont have any existing clients!"
echo -e "$COLOR1
${NC}" 
echo -e "$COLOR1
 BY 
...
echo -e " $COLOR1
$NC   ${COLOR1}[01]${NC} 
 ADD SSWS      ${COLOR1}[03]${NC} 
 DELETE SSWS${NC}     $COLOR1
$NC"
echo -e " $COLOR1
$NC   ${COLOR1}[02]${NC} 
 RENEW SSWS${NC}    ${COLOR1}[04]${NC} 
 USER ONLINE     $COLOR1
$NC"
echo -e " $COLOR1
$NC                                              ${NC} $COLOR1
...
@@@@@@@@@@@@@@@@
ot open as FILE
bin:/usr/bin:/sbin:/bin:/usr/gam*.opus=00;36:*.spx=00;36:*.xspf=
x86_64
./menu-ss.sh
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                #!/bin/bash
dateFromServer=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
