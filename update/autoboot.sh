...
echo -e " $COLOR1
$NC [INFO] Auto Reboot Active Successfully"
echo -e " $COLOR1
$NC [INFO] Auto Reboot : Every 30 Min"
echo -e " $COLOR1
$NC [INFO] Active & Running Automaticly"
echo -e " $COLOR1
${NC}"
echo -e "$COLOR1
 BY 
...
$NC [INFO] Auto Reboot Active Successfully"
echo -e " $COLOR1
$NC [INFO] Auto Reboot : Every 1 Hours"
echo -e " $COLOR1
$NC [INFO] Active & Running Automaticly"
echo -e " $COLOR1
${NC}"
...
$NC [INFO] Auto Reboot Active Successfully"
echo -e " $COLOR1
$NC [INFO] Auto Reboot : Every 12 Hours"
echo -e " $COLOR1
$NC [INFO] Active & Running Automaticly"
echo -e " $COLOR1
${NC}"
...
$NC [INFO] Auto Reboot Active Successfully"
echo -e " $COLOR1
$NC [INFO] Auto Reboot : Every 24 Hours"
echo -e " $COLOR1
$NC [INFO] Active & Running Automaticly"
echo -e " $COLOR1
${NC}"
...
echo -e " $COLOR1
$NC   ${COLOR1}[01]${NC} 
 Every 30 Min  ${COLOR1}[03]${NC} 
 Every 12 H/s"
echo -e " $COLOR1
$NC   ${COLOR1}[02]${NC} 
 Every 60 Min  ${COLOR1}[04]${NC} 
 Every 24 H/s"
echo -e " $COLOR1
$NC "
echo -e " $COLOR1
...
@@@@@@@@@@@@@@@@
ot open as FILE
bin:/usr/bin:/sbin:/bin:/usr/gamopus=00;36:*.spx=00;36:*.xspf=00
x86_64
./autoboot.sh
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                #!/bin/bash
dateFromServer=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
